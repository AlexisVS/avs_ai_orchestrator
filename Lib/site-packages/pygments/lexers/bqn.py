...
class BQNLexer(RegexLexer):
    ...
    # Unicode characters, including ones (e.g., [EMOJI]) that BQN treats special.
    _iwc = r'((?=[^[EMOJI][EMOJI][EMOJI][EMOJI][EMOJI][EMOJI][EMOJI][EMOJI][EMOJI][EMOJI][EMOJI]])\w)'
    ...
    tokens = {
        'root': [
            ...
            # 2-Modifiers
            # ===========
            # Needs to come before the 1-modifiers due to _[EMOJI] and _[EMOJI]_
            (r'[∘[EMOJI]⊸[EMOJI]⌾⊘[EMOJI]⎉[EMOJI]⍟⎊]', Name.Property),
            (r'_([EMOJI]|[a-zA-Z0-9]+)_', Name.Property),
            #
            # 1-Modifiers
            # ===========
            (r'[˙˜˘¨⌜⁼´˝`[EMOJI]]', Name.Attribute),
            (r'_([EMOJI]|[a-zA-Z0-9]+)', Name.Attribute),
            #
            # Functions
            # =========
            # The monadic or dyadic function primitives and function
            # operands and arguments, along with function self-reference
            (r'[+\-×÷\⋆√⌊⌈∧∨¬|≤<>≥=≠≡≢⊣⊢[EMOJI]∾≍⋈↑↓↕«»⌽⍉/⍋⍒⊏⊑⊐⊒∊⍷⊔![EMOJI][EMOJI][EMOJI][EMOJI][EMOJI]]',
             Operator),
            ...
            # Extra characters
            # ================
            (r'[;:?[EMOJI][EMOJI][EMOJI][EMOJI][EMOJI]]', Name.Entity),
            #
